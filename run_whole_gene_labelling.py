...
if __name__ == "__main__":
    ...
    learning_rate = args.get("lr", optimizer_config.get("learning_rate", 4e-4))
    epsilon = args.get("epsilon", optimizer_config.get("epsilon", 1e-6))
    beta1 = args.get("beta1", optimizer_config.get("beta1", 0.98))
    beta2 = args.get("beta2", optimizer_config.get("beta2", 0.9))
