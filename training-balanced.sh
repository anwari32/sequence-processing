...
# Seqlab
python3 run_train_seqlab_gene.py --training-config=training/config/by_genes/seqlab.training.non-overlap.b16.base.json --model-config=models/config/seqlab/config_seqlab.json
python3 run_train_seqlab_gene.py --training-config=training/config/by_genes/seqlab.training.non-overlap.b32.base.json --model-config=models/config/seqlab/config_seqlab.json
python3 run_train_seqlab_gene.py --training-config=training/config/by_genes/seqlab.training.non-overlap.b64.base.json --model-config=models/config/seqlab/config_seqlab.json
python3 run_train_seqlab_gene.py --training-config=training/config/by_genes/seqlab.training.non-overlap.b128.base.json --model-config=models/config/seqlab/config_seqlab.json